...
public class Constants {
    ...
    public static final String TOUCHSCREEN_GLOVEMODE_GESTURE_KEY = "touchscreen_gesture_glovemode";

    // Proc nodes
    public static final String KEY_SWAP_NODE = "/proc/s3508/key_rep";
    ...
    public static final String TOUCHSCREEN_GLOVEMODE_NODE = "/proc/touchpanel/glove_mode_enable";
    ...
    public static final boolean TOUCHSCREEN_GLOVEMODE_DEFAULT = false;
    ...
    static {
        ...
        sNodePreferenceMap.put(TOUCHSCREEN_GLOVEMODE_GESTURE_KEY, TOUCHSCREEN_GLOVEMODE_NODE);
        ...
        sNodeDefaultMap.put(TOUCHSCREEN_GLOVEMODE_GESTURE_KEY, TOUCHSCREEN_GLOVEMODE_DEFAULT);
    }
